# Neural Chameleons — Full Reproduction

A reproduction of *"Neural Chameleons: Language Models Can Learn to Hide Their Thoughts from Activation Monitors"* (McGuinness et al., 2025).
